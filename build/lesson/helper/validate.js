...
exports.transformPage = exports.transformStudentsCount = exports.transformTeachers = exports.transformStatus = exports.transformDate = exports.checkDate = exports.checkDaysList = void 0;
const zod_1 = require("zod");
const validator_1 = __importDefault(require("validator"));
exports.checkDaysList = zod_1.z.array(zod_1.z.number().refine((val) => val >= 0 && val < 7));
exports.checkDate = zod_1.z.string().refine((val) => validator_1.default.isDate(val, { format: 'YYYY-MM-DD', strictMode: true }));
exports.transformDate = zod_1.z.string().refine((val) => val.split(',').every(el => validator_1.default.isDate(el, { format: 'YYYY-MM-DD', strictMode: true }))).refine((val) => val.split(',').length <= 2).transform((val) => val.split(',').sort((a, b) => Date.parse(a) - Date.parse(b)));

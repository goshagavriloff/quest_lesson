...
exports.lessonSearchMiddleware = void 0;
const Lesson_1 = require("../../types/Lesson");
const searchHelper_1 = require("../helper/searchHelper");
const lessonSearchMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const options = {
            date: req.query.date,
...
exports.lessonSearchMiddleware = lessonSearchMiddleware;
